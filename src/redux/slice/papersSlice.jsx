...
export const getAllPapers = createAsyncThunk('papers/getAllPapers', 
...
export const createPaper= createAsyncThunk('papers/createPaper', 
...
export const updatePaper= createAsyncThunk(
  ...
  async ({_id,papersData} ,{ rejectWithValue }) => {
    try {
      ...
      const response = await Api.patch(`/papers/updatePaper/${_id}`, papersData,{
       headers: {
        'Content-Type': 'multipart/form-data'
      }});
      return response.data;
...
export const deletePaper= createAsyncThunk(
  ...
  async ({_id} ,{ rejectWithValue }) => {
    try {
      console.log(_id)
      const response = await Api.delete(`/papers/deletePaper/${_id}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data)
    }
